...
\cventry{2022 - 2023\\1 year}{Research Software Engineer}{Microsoft}{Confidential Computing}{Cambridge, UK}{
    I developed a ledger for software supply-chain transparency, based on the
    Confidential Consortium Framework. The ledger, written in \Cpp,
    executes inside of an SGX enclave. It records entries submitted by
    customers, enabling post-facto auditing of a service's software supply
    chain. The ledger issues receipts for offline verification of transactions.\\
    I participated in discussions at the IETF to create industry-wide standards
    for the format and semantics of the receipts issued by the ledger.
    %\\I implemented a novel data structure to provide freshness guarantees about
    %the state of the ledger, and designed new algorithms to update the data
    %structure in an efficient way.
}
\cventry{2021 - 2022\\1 year}{Distributed Systems Engineer}{Cloudflare}{}{London}{
    I was an engineer on Quicksilver, the distributed key-value store written in Go that
    ...
    designed a scheme to provide a consistent view to applications, even in the
    face of asynchronous replication. I led the design and development of a new caching
    layer to optimize median request latency.
}
\cventry{2019\\9 months}{Research Intern}{Microsoft Research}{Confidential Computing}{Cambridge, UK}{
    ...
    of which the Verona runtime is built. I lead the authorship of our paper
    describing the allocator's operation, and presented the results at the ISMM
    conference in Phoenix, AZ.
}
\cventry{2017 - 2018\\1 year}{Software Engineer}{Google}{Counter-Abuse Technology}{Zurich}{
...
\cventry{2016\\3 months}{Software Engineering Intern}{Google}{Android Security}{Mountain View}{
...
\cventry{2015\\3 months}{Software Engineering Intern}{Google}{Certificate Transparency}{London}{
    I added support for Certificate Transparency to Android's network stack.
    This required implementing new TLS extensions to BoringSSL and Conscrypt,
    the TLS implementations used by Android applications. I added an API
    allowing Android applications to opt-in to Certificate Transparency
    verification when establishing new network connections.
}

\cventry[1em]{2013 - 2014\\5 months}{Software Engineer}{DecaWave}{Dublin}{}{
    I participated in the development of embedded firmware for the company's
    STM32-based evaluation boards.  I worked on replacing the firmware's
    network stack from uIP to lwIP and implemented a Multicast DNS responder
    running on the evaluation board, allowing automatic discovery of the
    devices over the network.\\
    I assisted the research team in their algorithm development, and integrated
    the outcome of the research into the devices' firmware.
}
...
\cventry{2023}{When Concurrency Matters: Behaviour-Oriented Concurrency}{}{}{}{
    \textit{Proceedings of the ACM on Programming Languages}
}
\cventry{2019}{Snmalloc: a message passing allocator}{}{}{}{
    \textit{Proceedings of the 2019 ACM SIGPLAN International Symposium on Memory Management}
}

\section{Education}
\cventry{2019 - 2021}{PhD Program}{Imperial College}{London}{}{
    ...
    The type system forms the foundations of the Verona programming language developed in partnership with Microsoft Research.
